            ...
            <nav class="navbar navbar-default bootsnav  navbar-sticky navbar-scrollspy" data-minus-value-desktop="70"
                ...
                <div class="container">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="index.jsp">carvilla<span></span></a>
                    ...
                    <div class="collapse navbar-collapse menu-ui-design" id="navbar-menu">
                        <ul class="nav navbar-nav navbar-right" data-in="fadeInDown" data-out="fadeOutUp">
                            ...
                            <%} else {%>
                            <li><a style="text-transform: none"><%=user.getUserName()%>
                            </a></li>
                    ...
                    <div class="single-testimonial-box">
                        <div class="testimonial-description">
                            ...
                            <div class="testimonial-comment">
                                <p>
                                    Sed ut pers unde omnis iste natus error sit voluptatem accusantium dolor laudan rem
                                    aperiam, eaque ipsa quae ab illo inventore verit.
                                </p>
